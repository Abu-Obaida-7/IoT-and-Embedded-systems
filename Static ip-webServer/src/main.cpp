...
// -------- WiFi credentials --------
const char* ssid     = "Yo Mr White";
const char* password = "yoyo12321";

// -------- Static IP configuration --------
IPAddress local_IP(10,33,9,125);   // ESP32 IP (must fit your network)
IPAddress gateway(10,33,9,1);      // Router IP
